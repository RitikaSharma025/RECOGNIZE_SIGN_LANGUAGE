...
count = len(oss.listdir("C:\\Users\\91798\\Downloads\\American-sign-Language-main\\American-sign-Language-main\\FinalProject\\SourceCode\\AtoZ_3.1\\A\\"))
c_dir = 'A'
    ...
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("D:\\ASL\\Sign-Language-To-Text-and-Speech-Conversion\\AtoZ_3.1" + (c_dir) + "\\"))
